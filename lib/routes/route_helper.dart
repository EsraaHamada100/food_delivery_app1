...
class RouteHelper {
  ...
  static String getPopularFood({required int pageId, String? page}) => '$_popularFood?pageId=$pageId&page=$page';
  ...
  static List<GetPage> routes = [
    ...
    GetPage(
      ...
      page: () {
        ...
        return PopularFoodDetails(pageId: pageId, previousPage: page,);
      },
    ...
    GetPage(
      ...
      page: () {
        int pageId = int.parse(Get.parameters['pageId']!);
        String? page = Get.parameters['page'];
        return RecommendedFoodDetail(pageId: pageId, previousPage: page,);
      },
      transition: Transition.fadeIn,
    ),
